...
public class SimplePermissionNoticeDialog extends DialogFragment {
    ...
    private SimplePermissionNoticeCallback mCallback;
    ...
    public static SimplePermissionNoticeDialog newInstance(ArrayList<PermissionInfo> mandatoryPermissions,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMandatoryPermissions = (ArrayList<PermissionInfo>) args.getSerializable("mandatoryPermissions");
        ...
        mCallback = (SimplePermissionNoticeCallback) args.getSerializable("callback");
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putSerializable("callback", mCallback);
    }
    ...
    private boolean setPermissionList(ArrayList<PermissionInfo> target, LinearLayout container, RecyclerView recyclerView) {
        ...
        if (isEmpty) {
            ...
            if (mItemDividerDrawableResourceId != -1) {
                ...
                dividerItemDecoration.setDrawable(ContextCompat.getDrawable(getActivity(), mItemDividerDrawableResourceId));
    ...
    private View.OnClickListener mOnOkClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (mCallback != null) {
                mCallback.onDismiss(mPermissionCodes, mMandatoryPermissionCodes, mOptionalPermissionCodes);
                dismiss();
            }
        }
    };
